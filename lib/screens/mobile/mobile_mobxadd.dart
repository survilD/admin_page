...
class DataAddmobx extends StatefulWidget {
  final Map<String, dynamic> map;
  final bool isEdit;
  const DataAddmobx({Key? key, required this.map, required this.isEdit})
      : super(key: key);

  @override
  State<DataAddmobx> createState() => _DataAddmobxState();
}

class _DataAddmobxState extends State<DataAddmobx> {
  Job _tableadd = Job();
