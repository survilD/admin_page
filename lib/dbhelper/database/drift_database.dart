...
class AppDatabse extends _$AppDatabse {
  ...
  Future updateTodo(ModelData modelData) async {
    return await update(model).replace(modelData);
  }

  // Future feelingLazy(ModelCompanion modelCompanion) async{
  //   // delete the oldest nine tasks
  //   return await delete(model).where((tbl) => tbl.id.equals(model))
  // }
